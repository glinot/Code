// fill trainings // ten more recents
function getTrainingByBlock(nb) {
    $.get("/api/trainings/me/basic", {block_index: nb}, function (trainings) {
        trainings.forEach(function (training , i) {
...
$("#training-list > li ").click(function () {
    ...
    if ($(this).attr("filled") == "true") {
        window.location.hash = "sportman_training_filled";
    } else {
        console.log($(this).attr("id"));
        window.location.hash = "sportman_training_tofill";
    }
});
